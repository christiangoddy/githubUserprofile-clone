...
type UserProfileProps = {
  ...
  const UserProfile = ({ avatar_url, username, bio, location, public_repos }: UserProfileProps) => {
    const { resolvedTheme } = useTheme();
    return (
      <div className={`flex flex-col bg-white p-4 rounded-lg shadow-md mt-10 ${
